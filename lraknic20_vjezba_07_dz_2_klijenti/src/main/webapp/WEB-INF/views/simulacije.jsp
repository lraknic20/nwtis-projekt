...
<body>
	...
	<h2>Pretraživanje vožnji po id-u vozila</h2>
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/simulacije/pretrazivanjeVoznjiPoId">
		<table>
			<tr>
				<td>Id:</td>
	...
	<h2>Pretraživanje vožnji po id-u vozila u intervalu</h2>
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/simulacije/pretrazivanjeVoznjiPoIdOdDo">
		<table>
			<tr>
				<td>Id:</td>
				<td><input name="id" /> <input type="hidden"
	...
	<form method="post"
		action="${pageContext.servletContext.contextPath}/mvc/simulacije/voziloSpremi">
		<table>
			<tr>
				<td>Id:</td>
				<td><input name="id" /> <input type="hidden"
			...
			<tr>
				<td>&nbsp;</td>
				<td><input type="submit" value=" Spremi vožnju "></td>
			</tr>
		</table>
	</form>
	<p>${porukaSpremi}</p>
